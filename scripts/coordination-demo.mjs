...
import { TsuguClient } from "../packages/sdk/dist/index.js";
...
const client = new TsuguClient({ rpcUrl: RPC, privateKey: pk.startsWith("0x") ? pk : `0x${pk}` });
...
console.log("=== tsugu coordination layer — live on Shannon (chain 50312) ===\n");
