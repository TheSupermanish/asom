...
import { TsuguClient, capabilityTag, shannon } from "../packages/sdk/dist/index.js";
...
const client = new TsuguClient({ rpcUrl: RPC, privateKey: pk });
...
console.log("=== tsugu multi-agent coordination — live on Shannon (50312) ===\n");
