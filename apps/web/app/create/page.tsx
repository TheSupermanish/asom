  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      ...
      <p className="mt-2 text-neutral-400">
        Mint a <code className="text-cyan-300">name@tsugu</code> with its own ERC-6551 wallet — then let AI pick what it
        does.
      </p>
      ...
      {created && (
        <p className="mt-5 rounded-lg border border-green-800 bg-green-950/40 px-4 py-3 text-sm text-green-300">
          ✨ <strong>{created.name}@tsugu</strong> is live.{" "}
