...
/// @title  AgentRegistry — asom's name resolver and agent factory
...
/// @dev    Names are the asom namespace: `<name>@asom`. Validation is strict and
...
contract AgentRegistry is ReentrancyGuard {
    ...
    /// @dev Strict on-chain name validation for the `<name>@asom` namespace.
