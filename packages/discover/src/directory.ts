import { TsuguClient, capabilityTag } from "@tsugu/sdk";
 ...
 */
export async function loadAgents(client: TsuguClient, opts: LoadOptions = {}): Promise<AgentRecord[]> {
...
async function loadOne(client: TsuguClient, t: bigint, opts: LoadOptions): Promise<AgentRecord | null> {
  let name: string;
  try {
...
export class AgentDirectory {
  ...
  constructor(
    private readonly client: TsuguClient,
